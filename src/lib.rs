...
pub fn factorize(r: u32, e: u32, s: i32) -> (String, String) {
    todo!()
}

// pub fn factorize(n_str: &str) -> Result<Vec<(String, u32)>, NfsError> {
